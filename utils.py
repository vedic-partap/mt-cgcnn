...
if __name__ == '__main__':
    dataset1 = queryMPDatabse('1.csv', ["formation_energy_per_atom", "band_gap"],\
        print_data=False, fetch_cif=True, sample_fraction=1)
    dataset2 = queryMPDatabse('2.csv', ["formation_energy_per_atom", "band_gap"],\
        print_data=False, fetch_cif=True, sample_fraction=1)
    dataset3 = queryMPDatabse('3.csv', ["formation_energy_per_atom", "band_gap"],\
        print_data=False, fetch_cif=True, sample_fraction=1)
